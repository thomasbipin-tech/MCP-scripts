...
|---|---|
| Rounded block world ([10](../10-art-direction-and-cinematics.md)) | Hand-written WebGL2 instanced renderer, two generated meshes: a flat-faced cube for the world and a sphere for atmosphere and effects. Rolling green ground, a stone wall with two gaps, six stone towers, eight tall buildings, trees with rounded canopies, CSS-gradient sky per phase |
...
| **Battlefield points of interest** ([10](../10-art-direction-and-cinematics.md#act-i--citadel)) | Twelve houses with window gaps and pitched tile roofs, eight tall buildings, a pond with a sandy shore and plank bridge, eighteen rock formations, a ruined midfield wall with two gaps, six stone towers, trees with bushes, clouds overhead, and fogged distant hills for a horizon |
| **Climbable tall buildings** ([10](../10-art-direction-and-cinematics.md#stairs-a-body-can-actually-climb)) | Six to nine storeys, a ground-level doorway with a terraced approach path, a switchback staircase in two separate z-bands, a stairwell opening through each deck, and a parapet roof. Every dimension is derived from the collision box, and both the route *and* a physics-driven walk of it are verified on all eight |
| Restraint in density ([10](../10-art-direction-and-cinematics.md#restraint-is-part-of-the-style)) | One wall, eight tall buildings, scattered trees, and scenery kept clear of the towers so nothing grows through a stairwell. An earlier pass added floating islands, drifting motes and dozens of spires and was judged too crowded — objectives disappeared into the noise |
